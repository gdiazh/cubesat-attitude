...
t0 = [10.99, 18.73, 3.612, 15.96, 13.74, 9.621, 6.939, 1.751, 1.9311, 13.4];												%Input starting time
%Get from graph
...
im_final = [0.18, 0.18, 0.20, 0.22, 0.23, 0.26, 0.29, 0.32, 0.4, 0.43];
...
KM_i = [0.0663, 0.0729, 0.0775, 0.0759, 0.3630, 0.0596, 0.0535, 0.0745, 0.0656, 0.0777];
